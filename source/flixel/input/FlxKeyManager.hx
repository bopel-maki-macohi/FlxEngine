...
class FlxKeyManager<Key:Int, KeyList:FlxBaseKeyList> implements IFlxInputManager
{
	 ...
	 */
	public function anyPressed(KeyArray:Array<Key>):Bool
	{
	 ...
	 */
	public function anyJustPressed(KeyArray:Array<Key>):Bool
	{
	 ...
	 */
	public function anyJustReleased(KeyArray:Array<Key>):Bool
	{
 ...
 function onFocusLost():Void
	 ...
	 */
 function getKey(KeyCode:Int):FlxInput<Key>
	{
